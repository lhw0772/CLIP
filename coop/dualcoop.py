...
def load_clip_to_cpu(backbonename):
    ...
    model = build_model_conv_proj(state_dict or model.state_dict(), input_size=224)
...
def build_model(backbonename, classnames, args):
    ...
    arch_name += "{}".format('-' + args_prefix if args_prefix else "")
